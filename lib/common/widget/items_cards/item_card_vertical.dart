...
class BakoItemCardVertical extends StatelessWidget {
  const BakoItemCardVertical({super.key, required this.product});
          ...
          child: Column(
            children: [
              ...
              BakoRoundedContainer(
                ...
                child: BakoRoundImage(imageUrl: product.productImage, applyImageRadius: true, isNetworkImage: true,),
              ),
              const SizedBox(height: BakoSizes.spaceBtwItems/2,),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      // Sub title
                      children: [
                        Text("${(product.point).toString()} Points", overflow: TextOverflow.ellipsis, maxLines: 1, style: Theme.of(context).textTheme.bodyMedium),
